defmodule GreenManTavern.MixProject do
  use Mix.Project

  def project do
    [
      app: :green_man_tavern,
      version: "0.1.0",
      elixir: "~> 1.15",
  ...
  def application do
    [
      mod: {GreenManTavern.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind green_man_tavern", "esbuild green_man_tavern"],
      "assets.deploy": [
        "tailwind green_man_tavern --minify",
        "esbuild green_man_tavern --minify",
        "phx.digest"
      ],
